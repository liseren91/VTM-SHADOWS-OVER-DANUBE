...
export const TRANSLATIONS: Record<Language, Content> = {
  ...
  ru: {
    ...
    settingPage: {
      ...
      history: {
        ...
        timeline: [
          ...
          },
          {
            year: '2024-2025',
            title: 'Плохой год',
            description: 'Шабаш Белграда обрушился на нас серией точно выверенных ударов и старейшины, как водится, ответили волной птенцов, брошенных на передовую. Посреди хаоса регент Рахнич "героически" погиб в ритуале без свидетелей и без тела, а присланная из Рима ему на смену Франческа Орсини задаёт о нём вопросы, которые не задают о тех, кого действительно считают мёртвыми. Этот год оставил каждой котерии свой шрам — потерю товарища или части Человечности.'
          },
          {
            year: 'Ноябрь 2026',
            title: 'Мы здесь',
            description: 'Вроде как утряслось. Иерархия работает, Элизиум функционирует, правила соблюдаются. Относительная тишина после месяцев боёв нервирует больше, чем сами бои — стаи Шабаша ещё бегают, но то ли у них распри, то ли они копят силы, и обе версии одинаково неприятны. Иногда находят трупы с узнаваемым почерком. Есть слухи, что некоторые "новые" Камарильцы слишком хорошо знают ритуалы Шабаша. Старые враги не забывают обид.'
          }
        ]
      },
      geography: {
      ...
      adaptations: {
        ...
        items: [
          ...
          'События V5 (Дневник Джихада Беккета, уход Старейшин, Вторая Инквизиция, Гагрелы вышли из Камарильи) еще НЕ произошли.',
          'Геенна не наступила.',
    ...
    rulesPage: {
      title: 'Правила Игры',
      warning: {
        title: 'Правила Готовы, но могут меняться',
        text: 'Правила ролевый игры готовы, сейчас они могут менятся на основании обратной связи. Если увидете ошибки, или что то не понятно - сообщите нам'
      },
      sections: [
        {
          id: 'general',
