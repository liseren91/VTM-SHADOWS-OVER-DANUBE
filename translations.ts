              ...
              subsections: [
                ...
                },
                {
                  ...
                  list: [
                    ...
                    'Абсолютное Безумие (2 точки, видеть цель):Игрок извлекает сумасшествие из самых укромных уголков разума жертвы, сконцентрировав его во всепоглощающую волну безумия. Жертва получает 3 случайных психоза и обязана до конца стратегического цикларассвета действовать полностью в соответствии с ними, в ущерб всему остальному: здравому смыслу, интересам стаи и даже собственной безопасности. Игрок знает, какие именно психозы получает жертва. Использовать эту способность можно не более 2 раз за ночь, при этом на одного персонажа она подействует лишь один раз за ночь.',
